...
There is also a `.bedrock_agentcore.yaml` file output in the `hyperIvory` directory. This file contains a minimal definition with your agent name when it is created. After deploying the project, when running
